...
<!-- SPECKIT START -->
Active feature: **005-pgadmin-and-openai**. For technologies, project structure, shell commands,
and other context for the current work, read the plan at `specs/005-pgadmin-and-openai/plan.md`
