...
<!-- SPECKIT START -->
Active feature: **008-admin-managed-operator-accounts**. For technologies, project structure, shell
commands, and other context for the current work, read the plan at
`specs/008-admin-managed-operator-accounts/plan.md` (with its `research.md`, `data-model.md`,
