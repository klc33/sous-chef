...
tests) wire the whole public surface the same way. Favorites are added by User Story 3.
"""
...
from app.api.user import profile, recipes


def register_user_routers(app: FastAPI) -> None:
    """Attach the cook-facing routers (profile + recipes) to the app."""
